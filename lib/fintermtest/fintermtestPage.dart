...
class _FintermtestPage extends State<FintermtestPage> {
  ...
  var gradeCal_url = 'http://www.studyholic.com/m/student/grade/sd.asp';

  var semesterGradeCal_url = 'https://drive.google.com/drive/folders/1JFWsGek0tw9wSAgkYxh2QLqejkf6kUM7?usp=sharing';
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            RaisedButton(
              ...
              color: Colors.blueAccent,
              onPressed: () async {
                //await launch(gradeCal_url);
                Navigator.of(context).pushNamed('/fintermtest/calculate');
              },
            ),
            SizedBox(height: 10,),
            RaisedButton(
              ...
              color: Colors.blueAccent,
              onPressed: () async {
                await launch(semesterGradeCal_url);
              },
            )
          ],
        )
